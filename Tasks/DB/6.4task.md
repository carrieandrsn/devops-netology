...
vol-main
[root@node01 centos]# docker run --name my-postgres -e POSTGRES_PASSWORD=rootpass -it -v vol-main:/var/lib/postgresql/data -v vol-back:/var/lib/postgresql/ postgres:13
