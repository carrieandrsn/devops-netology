...
root@vagrant:/home/vagrant# cat no_sete.sh
#!/bin/bash

[[ -d /homecarrie ]] && echo complete!
[[ -d /home/carrie ]] && echo complete1!
root@vagrant:/home/vagrant# ./no_sete.sh
complete1!
root@vagrant:/home/vagrant# cat sete.sh
#!/bin/bash -e

[[ -d /homecarrie ]] && echo complete!
[[ -d /home/carrie ]] && echo complete1!
root@vagrant:/home/vagrant# ./sete.sh
complete1!
root@vagrant:/home/vagrant# 

наличие set -e не повлияло, так что использовать можно
